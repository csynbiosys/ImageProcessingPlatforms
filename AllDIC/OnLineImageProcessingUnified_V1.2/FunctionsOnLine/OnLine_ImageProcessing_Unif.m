...
switch handles.Device
    ...
    case 'Bacteria'
        Cmod = 'BacteriaDICTest1'; % Name of the weights file
        WriteMacroSegmentation_Bact(CellDirs,ident,IP,Cmod,RSA,cutcor); % Write macro ImageJ script for segmentation for cell directories
        WriteMacroSegmentation_Bact(BackDirs,ident,IP,Cmod,RSA,cutcorBACK); % Write macro ImageJ script for segmentation for background directories
end
...
switch handles.Device
    ...
    case 'Bacteria'
        ...
        sizeCell = cell(length(CellDirs),(maxt)/(CitFreq*60));
        save([mainDir,'\',ident,'_OutputFiles\TemporarySingleCellSize.mat'],'sizeCell');
end
