...
filePattern3 = fullfile([pDIC,'\CutDye'], 'exp*Sulforhodamine_001.png');
filePattern4 = fullfile([pDIC,'\CutDye'], 'exp*cy5_001.png');
...
r = 1:CitFreq/DicFreq:maxidD;
parfor i=1:maxidS % Citrine Images
    num = num2str(r(i),'%.3u');
    CSs{i} = imread([pDIC,'\CutDye\exp_000',num,'_Sulforhodamine_001.png']);
end

r = 1:CitFreq/DicFreq:maxidD;
parfor i=1:maxidCy % Citrine Images
    num = num2str(r(i),'%.3u');
    CCys{i} = imread([pDIC,'\CutDye\exp_000',num,'_cy5_001.png']);
end

save([pDIC, '\',ident,'-CutImages.mat'], 'CDs', 'CCs', 'CSs', 'CCys')
